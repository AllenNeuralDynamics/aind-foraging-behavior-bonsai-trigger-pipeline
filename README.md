...
| Processed results             | - ***S3 bucket***: `s3://aind-behavior-data/foraging_nwb_bonsai_processed/`<br>- ***CO data asset***: `foraging_nwb_bonsai_processed`<br>(id=4ad1364f-6f67-494c-a943-1e957ab574bb) | - ***S3 bucket***: `s3://aind-behavior-data/foraging_nwb_bpod_processed/`<br>- ***CO data asset***: `foraging_nwb_bpod`<br>(id=7f869b24-9132-43d3-8313-4b481effeead)
