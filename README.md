...
| Code Ocean data asset         | `foraging_nwb_bonsai`<br>(id=f908dd4d-d7ed-4d52-97cf-ccd0e167c659) | `foraging_nwb_bpod`<br>(id=4ba57838-f4b7-4215-a9d9-11bccaaf2e1c)  | 
| S3 bucket                     | s3://aind-behavior-data/foraging_nwb_bonsai/                    | s3://aind-behavior-data/foraging_nwb_bpod/                            |
